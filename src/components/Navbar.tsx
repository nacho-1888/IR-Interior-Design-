      ...
      >
        <div className="relative pointer-events-auto flex flex-col items-start justify-center h-24">
          ...
          >
            <Link 
              to="/" 
              className="text-6xl md:text-[8rem] lg:text-[10rem] branding-font font-bold leading-[0.95] md:leading-none tracking-tight block whitespace-nowrap text-left uppercase text-white"
            >
